package com.arduino.bluetooth10.utils
...
class BlueLib(
    ...
    private var DEVICE_ADDRESS = "dispAddres"
    ...
    fun onBluetooth (){
        ...
        if (listView!=null){
            ...
            viewDisp(mBtAdapter.bondedDevices)
        }else{
            dispEmparejadosLista = mBtAdapter.bondedDevices
        }
     ...
     * A)
     */
    private fun viewDisp(dispEmparejados: MutableSet<BluetoothDevice>) {
